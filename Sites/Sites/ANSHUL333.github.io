...
<body>
	...
	<div class="root">
		<h1 class="heading">Air Pollution prediction</h1>
		<div class="location-container">
			<h2 class="sub-heading">  Give Your Location please :</h2>
            ...
            <a href="C:\Users\anshu\OneDrive\Desktop\air quali predic\PRECAU.HTML">PRECAUTIONS</a>
		</div>
		<div class="air-info">
			<h2 class="sub-heading">Air Quality Index (AQI) :</h2>
		...
		<footer>
			Plant more <img src="C:\Users\anshu\OneDrive\Desktop\air quali predic\tree.svg" width="35" height="35" />
		</footer>
	</div>
